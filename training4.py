...
def get_args(**overrides):
    ...
    parser.add_argument("--pert", type=float, default=0.0,
...
def prepare_batches(key, data, batch_size, num_atoms=29, dst_idx_flat=None, src_idx_flat=None, batch_segments=None, PERT=0.0):
    """
    ...
    for idx, perm in enumerate(perms):
        ...
        rot = e3x.so3.random_rotation(rotation_key, perturbation=PERT, num=len(data['energies'][perm]))
...
def train_model(key, model, train_data, valid_data, num_epochs, learning_rate, batch_size, 
                ...
                gradient_checkpoint=False, PERT=0):
    """
